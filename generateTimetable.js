...
// APP_SECRET must be set via environment variable (e.g. GitHub Actions secret or local .env)
const APP_SECRET = process.env.APP_SECRET;
if (!APP_SECRET) {
    console.error("ERROR: Missing APP_SECRET environment variable. Please set APP_SECRET before running.");
    process.exit(1);
}
